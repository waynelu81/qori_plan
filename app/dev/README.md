...
| [`../design/positioning-solo-creators.md`](../design/positioning-solo-creators.md)                               | Where Qori sits on a solo creator's path, read off Justin Welsh's, and the voice for the start of it                                                            |
| [`../design/competitor-kajabi.md`](../design/competitor-kajabi.md)                                               | Kajabi as the platform the grown creator moves to: what to take from its flows, and what not to                                                                |
